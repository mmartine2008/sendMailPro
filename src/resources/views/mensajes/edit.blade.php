<x-app-layout>
    <div class="max-w-4xl mx-auto py-8">
        <h2 class="text-2xl font-semibold mb-4">Editar mensaje</h2>
        ...
        <div class="bg-white shadow rounded p-6">
            <form method="POST" action="{{ route('mensajes.update', $mensaje) }}">
                ...
                <div class="mb-4">
                    ...
                    <textarea name="body" class="wysiwyg w-full h-64" required>{{ $mensaje->body }}</textarea>
                </div>
